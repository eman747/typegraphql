...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/emanshahbaz/Downloads/GraphQL/typegraphql-prisma-postgresql/prisma/generated/type-graphql",
      "fromEnvVar": null
    },
    "config": {
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  ...
  config.dirname = path.join(process.cwd(), "prisma/generated/type-graphql")
...
path.join(process.cwd(), "prisma/generated/type-graphql/libquery_engine-darwin-arm64.dylib.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/type-graphql/schema.prisma")
